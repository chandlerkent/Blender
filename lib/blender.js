...
OptionsParser.usage("INPUT_FILE [OUTPUT_DIR]");
...
exports.main = function() {
    ...
    var output_dir = File.absolute(options.args[1] || File.cwd());
    ...
    var output = File.absolute(File.join(output_dir, options["class"] + "+" + stylesheet.themeName + ".j"));
